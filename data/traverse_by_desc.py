...
'''
# validate children and parents
for sub in stored_descs:
    if stored_descs[sub] != False:
        for child in stored_descs[sub]['children']:
            if stored_descs[child] != False and sub not in stored_descs[child]['parents']:
                stored_descs[child]['parents'].append(sub)
'''
'''
#remove duplicates
for sub in stored_descs:
    if stored_descs[sub] != False:
        stored_descs[sub]['children'] = list(set(stored_descs[sub]['children']))
        stored_descs[sub]['parents'] = list(set(stored_descs[sub]['parents']))
'''
...
with open('data/stored_descs.json', 'w') as store:
